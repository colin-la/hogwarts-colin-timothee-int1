...
def create_character():
    ...
    print_slow("Choose your attributes: ")
...
def receive_letter():
    ...
    if choice == 1:
        print_slow("Thank you, we'll be waiting for you on the platform 9 and 3/4")
        print_slow("in order to take the Hogwarts Express")
...
def buy_supplies(character: dict) -> None:
    ...
    while len(required) > 0:
        ...
        if character["Money"] < dict_items[str(choice)][1]:
            ...
            print_slow("GAME OVER", vitesse=60)
            sys.exit()
